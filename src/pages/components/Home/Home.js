            ...
            <div className="home container-fluid my-5 pt-lg-5 pb-5">
                <div className="row pt-5">
                    <div className="offset-xl-2 col-xl-5 offset-lg-1 col-lg-6 offset-md-1 col-md-6 offset-sm-1 col-sm-10 offset-1 col-10 pb-5">
                        ...
                        <br/>
                        <a href="mailto:danwei002@gmail.com"><FaEnvelope size={32} color={"#deddcc"} className="mt-5 mr-5 grow-hover-effect"/></a>
                        <a href="https://github.com/danwei002"><FaGithub size={32} color={"#9413f0"} className="mt-5 mr-5 grow-hover-effect"/></a>
                        <a href="https://www.linkedin.com/in/danwei002/"><FaLinkedin size={32} color={"#0e76a8"} className="mt-5 mr-5 grow-hover-effect"/></a>
                    </div>
