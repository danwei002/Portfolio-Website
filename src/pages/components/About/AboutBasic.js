    ...
    return (
        <div className="about-wrapper row pb-5">
            <div className="offset-xl-2 col-xl-5 offset-lg-1 col-lg-6 offset-md-1 col-md-6 offset-sm-1 col-sm-10 offset-1 col-10 pb-5">
                ...
                <hr style={{borderColor: themeCtx.border}}/>
                ...
                <p className="lead">
                    ...
                    suggestions, some of my favourites are: Brooklyn 99, The Queen's Gambit, Lucifer, The 100, Shadow and Bone, and The Last Dance.
                </p>
            </div>
        </div>
    )
